...
<div class="box_content">
    <div class="row">
        ...
        <div class="col-lg-4">
            Ngày lập
            <input type="date" name="CreateAt" id="CreateAt" value="{{ $time->toDateString() }}">
        </div>
        <div class="col-lg-4">
            Người lập: 
...
<script>
    ...
    $('#btnAdd').on("click", async function(){
        ...
        var flag = false;
        await $.get('/purchase/checkSerialNumber',{id:idproduct,serialNumber:imeiArray},function(res){
            if(res!=""){
